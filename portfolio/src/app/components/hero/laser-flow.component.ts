...
@Component({
  selector: 'setya-laser-flow',
  standalone: true,
  template: `<div #container class="laser-flow-container"></div>`,
  styles: [
    `
      :host {
        display: block;
...
export class LaserFlowComponent implements AfterViewInit, OnDestroy {
  ...
  @Input() wispDensity = 1;
  @Input() dpr?: number;
  @Input() mouseSmoothTime = 0.0;
  @Input() mouseTiltStrength = 0.01;
  @Input() horizontalBeamOffset = 0.0;
  @Input() verticalBeamOffset = -0.35;
  @Input() flowSpeed = 0.35;
  @Input() verticalSizing = 2.0;
  @Input() horizontalSizing = 0.5;
  @Input() fogIntensity = 0.45;
  @Input() fogScale = 0.3;
  @Input() wispSpeed = 15.0;
  @Input() wispIntensity = 5.0;
  @Input() flowStrength = 0.25;
  @Input() decay = 1.1;
  @Input() falloffStart = 1.2;
  @Input() fogFallSpeed = 0.6;
  @Input() color = '#FF79C6';
